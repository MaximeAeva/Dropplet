            ...
            if(this->mat[raw][col].drop && !this->mat[raw][col].moved)//If a drop, look forces around
            {
                ...
                {  
                    ...
                    else if(this->mat[raw+sraw][col+scol].drop)
                    {
                        ...
                        //Receive
                        this->mat[raw][col].receive[i] += transmission*k/2.15*this->mat[raw+sraw][col+scol].give[(i+4)%8];
                        //Give
                        this->mat[raw][col].receive[i] += transmission*k/2.15*this->mat[raw][col].give[i];
                    }
                }
